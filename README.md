...
<img width="457" height="64" alt="image" src="https://github.com/user-attachments/assets/3cf018c7-e554-48a3-8522-9c75f348b9d9" />

<br>
<br>
       
![Static Badge](https://img.shields.io/badge/tests-failing-red?logo=github) ![Static Badge](https://img.shields.io/badge/downloads-32.M-green) ![Static Badge](https://img.shields.io/badge/packagist-v%201.8.3-blue) ![Static Badge](https://img.shields.io/badge/license-MIT-green)
...
| Tinker | Execute arbitrary code within the context of the applicatio


## Available AI Guidelines
Laravel Boost includes AI guidelines for the following packages and frameworks. The core guidelines provide generic, generalized advice to the AI for the given package that is applicable across all version.


| Packag | Versions Supported
| ------ | -------|
Core & Boost | core
...
Thank you for considering contributing to Boost! The contribution guide can be found in the [Laravel documentation.](https://laravel.com/docs/12.x/contributions)

## Code of Conduct

In order to ensure that the Laravel community is welcoming to all, please review and abide by the [Code of Conduct.](https://laravel.com/docs/12.x/contributions#code-of-conduct)
...
Laravel Boost is open-sourced software licensed under the [MIT license.](https://github.com/laravel/boost/blob/main/LICENSE.md)
